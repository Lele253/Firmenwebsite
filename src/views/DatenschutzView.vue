<template>
  <div class="pa-5" style="background-color: transparent; overflow-y: scroll; margin-top: 100px; height: 100vh;">
    <div class="">
      ...
      <p>
        ...
        Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies
      ...
      <p>
        Name: Leandro Graf / Stefan Franke
        <br>
      ...
      <p>
        ...
        außerdem auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO. Sofern Sie in die Speicherung von Cookies oder
        in den Zugriff auf Informationen in Ihr Endgerät (z.&nbsp;B. via Device-Fingerprinting) eingewilligt
        ...
        vorvertraglicher Maßnahmen erforderlich, verarbeiten wir Ihre Daten auf Grundlage des Art. 6 Abs. 1
        ...
        Über die jeweils im Einzelfall einschlägigen Rechtsgrundlagen wird in den folgenden Absätzen dieser
      ...
      <p>
        ...
        dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG); die Einwilligung ist jederzeit
        widerrufbar.
      </p>
